  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="addSiswaForm" method="POST" action="{{ url('admin/user-siswa') }}" enctype="multipart/form-data">
          @csrf
          <div class="row">
            <div class="col-md-4">
...
<div class="modal fade" id="editSiswaModal-{{ $a->id }}" tabindex="-1" role="dialog" aria-labelledby="editSiswaModal-label-{{ $a->id }}" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="editSiswaForm-{{ $a->id }}" method="POST" action="{{ url('/admin/user-siswa/'. $a->id) }}" enctype="multipart/form-data">
          @csrf
          @method('PUT')
          <div class="row">
            <div class="col-md-4">
...
<div class="modal fade" id="deleteSiswaModal-{{ $a->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteSiswaModal-label-{{ $a->id }}" aria-hidden="true">
  <div class="modal-dialog" role="document">
      <div class="modal-content">
          ...
          <div class="modal-footer">
              <form method="POST" action="{{ url('/admin/user-siswa/'.$a->id)}}">
                  @csrf
                  @method('DELETE')
                  <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal"><i class="fa-solid fa-close"></i></button>
