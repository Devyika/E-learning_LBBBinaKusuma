      ...
      <div class="card-body">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <button type="button" class="btn btn-success btn-sm float-right" data-toggle="modal" data-target="#addSiswaModal">
                    ...
                    @if ($siswa->count() > 0)
                      ...
                      <tr>
                        ...
                        <td class="d-flex justify-content-around">
                          ...
                          <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#editSiswaModal-{{ $a->id }}">
                            <i class="fa-solid fa-pen-to-square"></i>
                          </button>
                          <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteSiswaModal-{{ $a->id }}">
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="addSiswaForm" method="POST" action="{{ url('admin/input-siswa') }}" enctype="multipart/form-data">
          @csrf
          <div class="row">
            <div class="col-md-4">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary btn-sm" form="addSiswaForm"><i class="fa-solid fa-save"></i></button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="detailModal{{$a->id}}" tabindex="-1" role="dialog" aria-labelledby="detailModalLabel{{$a->id}}" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="detailModalLabel{{$a->id}}"><strong>Detail Siswa </strong>{{$a->name}}</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
@foreach ($siswa as $a)
<div class="modal fade" id="editSiswaModal-{{ $a->id }}" tabindex="-1" role="dialog" aria-labelledby="editSiswaModal-label-{{ $a->id }}" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="editSiswaModal-label-{{ $a->id }}"><strong>Edit Siswa </strong>{{ $a->name }}</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form id="editSiswaForm-{{ $a->id }}" method="POST" action="{{ url('/admin/input-siswa/'. $a->id) }}" enctype="multipart/form-data">
          @csrf
          @method('PUT')
          <div class="row">
            <div class="col-md-4">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal"><i class="fa-solid fa-close"></i></button>
        <button type="submit" class="btn btn-primary btn-sm" form="editSiswaForm-{{ $a->id }}"><i class="fa-solid fa-save"></i></button>
      </div>
    </div>                              
  </div>
</div>   
...
@foreach ($siswa as $a)
<div class="modal fade" id="deleteSiswaModal-{{ $a->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteSiswaModal-label-{{ $a->id }}" aria-hidden="true">
  <div class="modal-dialog" role="document">
      <div class="modal-content">
          <div class="modal-header">
              <h5 class="modal-title" id="deleteSiswaModal-label-{{ $a->id }}"><strong>Hapus Siswa </strong>{{ $a->name }}</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
              </button>
          </div>
          ...
          <div class="modal-footer">
              <form method="POST" action="{{ url('/admin/input-siswa/'.$a->id)}}">
                  @csrf
                  @method('DELETE')
                  <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal"><i class="fa-solid fa-close"></i></button>
